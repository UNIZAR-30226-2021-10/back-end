...
io.on('connection', (socket) => {
    ...
    socket.on('join', ({username, code, firstJoin}, callback) =>{
        ...
        if (firstJoin){
            ...
            const mensajeUserJoin = {sender: 'admin', avatar: '/images/usuario.png', text: "Bienvenido al chat "+ user.username, date: "admin" };
            ...
            // 'admin' envía message al usuario que se ha unido 'user.username'
            const mensajeUserJoin = {sender: 'admin', avatar: '/images/usuario.png', text: "Bienvenido de nuevo "+ user.username, date: "admin" };
            socket.emit('message', mensajeUserJoin);
            // 'admin' envía message a todos los usuarios de la sala de 'user.username'
            const mensajeUsersInChat = {sender: 'admin', avatar: '/images/usuario.png', text: "Ha vuelto "+ user.username, date: "admin" };
            socket.broadcast.to(user.code).emit('message', mensajeUsersInChat);
        }
